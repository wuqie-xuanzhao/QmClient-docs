...
> 当前入口是 [demo-spectator-status.html](../../planning/demo-spectator-status.html)。
>
> 本文是旧调研/旧方案，只保留历史上下文。当前 Demo marker、slice、speed、Qm HUD/input 回放、Ghost 和 LiveDirector/MultiView 状态以 HTML 状态页为准。
